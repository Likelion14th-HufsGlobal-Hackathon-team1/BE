...
class ProductScanControllerTest {
    ...
    void 본인이_등록한_제품코드로_스캔하면_200을_반환한다() throws Exception {
        productRepository.save(Product.register(1L, "SCAN-OWN-001", "Aren Shopper", null, null, null, LocalDate.now()));
    ...
    void 남이_등록한_제품코드로_스캔하면_404를_반환한다() throws Exception {
        productRepository.save(Product.register(1L, "SCAN-OTHER-001", "Aren Shopper", null, null, null, LocalDate.now()));
